...
import { ArrowLeft, Plus, Loader2, Users, Trophy, Shield, Pencil, Trash2, MoreVertical, RefreshCw } from 'lucide-react';
        ...
        <Card className="@container/card">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-lg font-semibold">
              <Badge variant={championship.status === 'ongoing' ? 'default' : 'secondary'} className="bg-redish hover:bg-redish/80">
                {championship.status}
              </Badge>
            </CardTitle>
          </CardHeader>
